...
namespace OpenWifi {
	typedef Poco::Tuple<uint64_t,	 //     timestamp=OpenWifi::Now();
	...
	class WifiClientHistoryDB
		: public ORM::DB<WifiClientHistoryDBRecordType, AnalyticsObjects::WifiClientHistory> {
	  public:
